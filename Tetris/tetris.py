...
bg = pygame.image.load('space1.png').convert()
game_bg = pygame.image.load('image4.jpg').convert()
...
title_score = font.render('Wynik:', True, pygame.Color('white'))
title_record = font.render('Rekord:', True, pygame.Color('white'))
...
while True:
    ...
    sc.blit(title_score, (535, 400))
    sc.blit(font.render(str(score), True, pygame.Color('white')), (550, 500))
    sc.blit(title_record, (525, 650))
    sc.blit(font.render(record, True, pygame.Color('white')), (550, 720))
    # game over
    for i in range(W):
        if field[0][i]:
